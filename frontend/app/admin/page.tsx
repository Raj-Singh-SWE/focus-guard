    ...
    return (
        <div className="space-y-6">
            <header>
                ...
                <p className="text-slate-500 mt-1">Manage user profile, license, and vehicle insurance renewals.</p>
            </header>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">

                {/* License Card */}
                <div className={`p-6 rounded-xl border transition-all ${isLicenseCritical ? 'border-red-500/50 bg-red-950/10' : 'border-slate-200 bg-white shadow-sm'}`}>
                    ...
                    <div className="mt-8">
                        <p className="text-slate-500 mb-1 text-sm uppercase tracking-wide font-medium">Expires in</p>
                ...
                {/* Insurance Card */}
                <div className={`p-6 rounded-xl border transition-all ${isInsuranceCritical ? 'border-red-500/70 bg-red-500/5 shadow-[0_0_20px_rgba(239,68,68,0.1)]' : 'border-slate-200 bg-white shadow-sm'}`}>
                    <div className="flex justify-between items-start">
                        <div className="flex items-center">
